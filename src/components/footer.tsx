    ...
    return (
        <div className="py-[100px] text-textColor/80 text-start w-[100%]">
            ...
            <div className="flex space-x-10 items-center mt-10">
                <h1 className="text-textColor/80  text-xl">Netflix Vietnam</h1>
                <ul className="flex space-x-5 text-white cursor-pointer">
                    <li>
                        <Link
                            target="_blank"
                        ...
                        >
                            <svg
                                ...
                                className="hover:scale-110 svg-icon svg-icon-facebook-logo"
                            >
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                    ...
                    <li>
                        <Link target="_blank" href="https://twitter.com/NetflixAsia">
                            <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                className="hover:scale-110 svg-icon svg-icon-instagram-logo"
                            >
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                    ...
                    <li>
                        <Link target="_blank" href="https://www.instagram.com/netflixasia/">
                            <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                className="hover:scale-110 svg-icon svg-icon-twitter-logo"
                            >
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                    ...
                    <li>
                        <Link target="_blank" href="https://www.youtube.com/channel/UCZoC-XeDO7HxbAdeCaRPPCw/videos">
                            <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                className="hover:scale-110 svg-icon svg-icon-youtube-logo"
                            >
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
